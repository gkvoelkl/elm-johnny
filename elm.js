...
var $author$project$Main$randomInt = F2(
	function (min, max) {
		return A2($elm$random$Random$int, min, max);
	});
...
var $author$project$Main$initApple = function (seed) {
	var _v0 = A2(
		$elm$random$Random$step,
		A2($author$project$Main$randomInt, 64, 360),
		seed);
	var x = _v0.a;
	var seed1 = _v0.b;
	var _v1 = A2(
		$elm$random$Random$step,
		A2($author$project$Main$randomInt, 64, 240),
		seed1);
	var y = _v1.a;
	var seed2 = _v1.b;
	return _Utils_Tuple2(
...
var $author$project$Main$initKeys = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('Left', false),
			_Utils_Tuple2('Right', false),
			_Utils_Tuple2('Up', false),
			_Utils_Tuple2('Down', false)
		]));
...
var $author$project$Main$initPlayer = {
	animations: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'Left',
				$elm$core$Array$fromList(
					_List_fromArray(
						['assets/images/player_14.png', 'assets/images/player_15.png']))),
				_Utils_Tuple2(
				'Right',
				$elm$core$Array$fromList(
					_List_fromArray(
						['assets/images/player_11.png', 'assets/images/player_12.png']))),
				_Utils_Tuple2(
				'Up',
				$elm$core$Array$fromList(
					_List_fromArray(
						['assets/images/player_03.png', 'assets/images/player_04.png']))),
				_Utils_Tuple2(
				'Down',
				$elm$core$Array$fromList(
					_List_fromArray(
						['assets/images/player_01.png', 'assets/images/player_24.png']))),
				_Utils_Tuple2(
				'Default',
				$elm$core$Array$fromList(
					_List_fromArray(
						['assets/images/player_23.png', 'assets/images/player_23.png'])))
			])),
	currentSlot: 'Default',
...
var $author$project$Main$randomFloat = F2(
	function (min, max) {
		return A2($elm$random$Random$float, min, max);
	});
var $author$project$Main$initRectangle = function (seed) {
	var _v0 = A2(
		$elm$random$Random$step,
		A2($author$project$Main$randomInt, 0, 490),
		seed);
	var x = _v0.a;
	var seed1 = _v0.b;
	var _v1 = A2(
	...
	var _v2 = A2(
		$elm$random$Random$step,
		A2($author$project$Main$randomInt, 0, 100),
		seed2);
	var width = _v2.a;
	var seed3 = _v2.b;
	var _v3 = A2(
	...
	var _v4 = A2(
		$elm$random$Random$step,
		A2($author$project$Main$randomInt, 0, 255),
		seed4);
	var r = _v4.a;
	var seed5 = _v4.b;
	var _v5 = A2(
	...
	var b = _v6.a;
	var seed7 = _v6.b;
	var fill = 'rgb(' + ($elm$core$String$fromInt(r) + (',' + ($elm$core$String$fromInt(g) + (',' + ($elm$core$String$fromInt(b) + ')')))));
	var _v7 = A2(
		$elm$random$Random$step,
		A2($author$project$Main$randomFloat, 0.05, 0.15),
		seed7);
	var velocity = _v7.a;
	var seed8 = _v7.b;
	return _Utils_Tuple2(
		{fill: fill, height: height, velocity: velocity, width: width, x: x, y: y},
		seed8);
};
var $author$project$Main$initRectangles = F3(
	function (count, seed, list) {
		initRectangles:
		while (true) {
			if (!count) {
				return _Utils_Tuple2(list, seed);
			} else {
				var _v0 = $author$project$Main$initRectangle(seed);
				var newRectangle = _v0.a;
				var newSeed = _v0.b;
				var newList = A2($elm$core$List$cons, newRectangle, list);
...
var $author$project$Main$keyToPlayerAction = function (keyString) {
	switch (keyString) {
		case 'ArrowUp':
			return $elm$json$Json$Decode$succeed('Up');
		case 'ArrowDown':
			return $elm$json$Json$Decode$succeed('Down');
		case 'ArrowLeft':
			return $elm$json$Json$Decode$succeed('Left');
		case 'ArrowRight':
			return $elm$json$Json$Decode$succeed('Right');
		default:
			return $elm$json$Json$Decode$succeed('Any');
	}
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$keyDecoder = A2(
	$elm$json$Json$Decode$andThen,
	$author$project$Main$keyToPlayerAction,
...
var $author$project$Main$updatePlayer = F4(
	function (player, keys, touch, timeDelta) {
		...
		var currentSlot = _Utils_eq(
			...
			$elm$core$Maybe$Just(true)) ? 'Left' : (_Utils_eq(
...
var $author$project$Main$updateRectangleY = F2(
	function (timeDelta, rectangle) {
		var diff = $elm$core$Basics$floor(rectangle.velocity * timeDelta);
		var newY = ((rectangle.y + diff) > 510) ? (-20) : (rectangle.y + diff);
		return _Utils_update(
			rectangle,
			{y: newY});
	});
var $author$project$Main$updateRectangles = F2(
	function (rectangles, timeDelta) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$updateRectangleY(timeDelta),
			rectangles);
	});
var $author$project$Main$updateTime = F2(
	function (timeDelta, time) {
		return A2($elm$core$Basics$max, time - timeDelta, 0);
	});
var $author$project$Main$updateOnFrame = F2(
	function (model, timeDelta) {
		...
		var touching = (_Utils_cmp(
			...
			$elm$core$Basics$abs(player.y - model.apple.y),
			model.apple.size) < 0);
		var score = touching ? (model.score + 1) : model.score;
		var time = _Utils_eq(gameStatus, $author$project$Main$Running) ? A2($author$project$Main$updateTime, timeDelta, model.time) : model.time;
		var _v0 = touching ? A2(
			$elm$random$Random$step,
			A2($author$project$Main$randomInt, 64, 420),
			model.seed) : _Utils_Tuple2(model.apple.x, model.seed);
		var x = _v0.a;
		var seed1 = _v0.b;
		var _v1 = touching ? A2(
			$elm$random$Random$step,
			A2($author$project$Main$randomInt, 64, 420),
			seed1) : _Utils_Tuple2(model.apple.x, seed1);
		var y = _v1.a;
		var seed2 = _v1.b;
		var apple = {size: model.apple.size, x: x, y: y};
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					...
					player: player,
					rectangles: A2($author$project$Main$updateRectangles, model.rectangles, timeDelta),
					score: score,
					seed: seed2,
					time: time
				}),
...
var $author$project$Main$viewMessage = function (gameStatus) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$fontSize('60px'),
...
var $author$project$Main$viewPlayerImage = function (player) {
	...
	var maybeArray1 = A2(
		...
		$elm$core$Array$fromList(
			_List_fromArray(
				['assets/images/player_01.png'])),
		maybeArray);
	var maybeElement = A2($elm$core$Array$get, player.currentSlotElement, maybeArray1);
	var element = A2($elm$core$Maybe$withDefault, 'assets/images/player_01.png', maybeElement);
	return element;
};
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $elm$svg$Svg$rect = $elm$svg$Svg$trustedNode('rect');
var $elm$svg$Svg$Attributes$width = _VirtualDom_attribute('width');
var $author$project$Main$viewRectangle = function (rectangle) {
	return A2(
		$elm$svg$Svg$rect,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$x(
				$elm$core$String$fromInt(rectangle.x)),
				$elm$svg$Svg$Attributes$y(
				$elm$core$String$fromInt(rectangle.y)),
				$elm$svg$Svg$Attributes$width(
				$elm$core$String$fromInt(rectangle.width)),
				$elm$svg$Svg$Attributes$height(
				$elm$core$String$fromInt(rectangle.height)),
				$elm$svg$Svg$Attributes$fill(rectangle.fill)
			]),
		_List_Nil);
};
var $author$project$Main$viewRectangles = function (rectangles) {
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$viewRectangle, rectangles));
};
var $author$project$Main$viewScoreTime = F2(
	function (score, time) {
		var seconds = $elm$core$Basics$floor(time / 1000);
		var timeString = (seconds >= 60) ? '1:00' : ('0:' + ((seconds < 10) ? ('0' + $elm$core$String$fromInt(seconds)) : $elm$core$String$fromInt(seconds)));
		return A2(
			$elm$svg$Svg$g,
			_List_fromArray(
				[
...
var $author$project$Main$view = function (_v0) {
	...
	var rectangles = _v0.rectangles;
	var screenWidth = _v0.screenWidth;
	var screenHeight = _v0.screenHeight;
	var score = _v0.score;
	var time = _v0.time;
	var apple = _v0.apple;
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$width(
				$elm$core$String$fromInt(screenWidth)),
				$elm$svg$Svg$Attributes$height(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$viewBox(
						'0 0 ' + ($elm$core$String$fromInt(screenWidth) + ' 100')),
						$elm$svg$Svg$Attributes$style('background: green')
					]),
				_List_fromArray(
					[
						A2($author$project$Main$viewScoreTime, score, time)
					])),
				A2(
				$elm$svg$Svg$g,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$transform('translate(0 100)'),
						$elm$svg$Svg$Attributes$width(
						$elm$core$String$fromInt(screenWidth)),
						$elm$svg$Svg$Attributes$height(
						$elm$core$String$fromInt(screenHeight)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$xlinkHref('assets/images/apple.png'),
								$elm$svg$Svg$Attributes$x(
								$elm$core$String$fromInt(apple.x)),
								$elm$svg$Svg$Attributes$y(
								$elm$core$String$fromInt(apple.y)),
								$elm$svg$Svg$Attributes$width(
								$elm$core$String$fromInt(apple.size)),
								$elm$svg$Svg$Attributes$height(
								$elm$core$String$fromInt(apple.size))
							]),
						_List_Nil),
						$author$project$Main$viewRectangles(
						A2($elm$core$List$take, 20, rectangles)),
						A2(
						$elm$svg$Svg$image,
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$xlinkHref(
								$author$project$Main$viewPlayerImage(player)),
								$elm$svg$Svg$Attributes$x(
						...
						_List_Nil),
						$author$project$Main$viewRectangles(
						A2($elm$core$List$drop, 20, rectangles)),
						$author$project$Main$viewMessage(gameStatus)
					]))
			]));
};
